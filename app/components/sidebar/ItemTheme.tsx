    ...
    return (
        ...
        >
            ...
            <li className="sidebar__item justify-between" onClick={() => setTheme("light")}>
                <span>Terang</span>
                {theme === "light" && <FaCheck className="w-3 h-3 text-zinc-400" />}
            </li>
            <li className="sidebar__item justify-between" onClick={() => setTheme("dark")}>
                <span>Gelap</span>
                {theme === "dark" && <FaCheck className="w-3 h-3 text-zinc-400" />}
            </li>
            <li className="sidebar__item justify-between" onClick={() => setTheme("system")}>
                <span>Sistem</span>
                {theme === "system" && <FaCheck className="w-3 h-3 text-zinc-400" />}
            </li>
        </motion.ul>
    )
}
