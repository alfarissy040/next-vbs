...
const PermintaanAktivasi = (namaKacab: String, nonas: String, namaNas: String) => {
    return (
        <Html>
            <Tailwind>
                    ...
                    <div className="max-w-md mx-auto bg-white rounded-lg overflow-hidden mt-10 shadow-lg">
                        ...
                        <div className="p-6">
                            ...
                            <p className="text-gray-700 mb-4">
                                We have received a request for data activation with the following details:
                            </p>
...
export default PermintaanAktivasi